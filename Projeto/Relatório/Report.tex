...
Tanto o áudio como vídeo possuem um \underline{comprimento} da sua duração em segundos.

\subsection{Áudio}

\textbf{Possíveis extensões:} .mp3, .wav, ...

\subsection{Imagem}

\textbf{Possíveis extensões:} .jpg, .png, .bmp, ...

\subsection{Vídeo}

\textbf{Possíveis extensões:} .avi, .mp4, .wmv, ...
...
Um \textbf{evento} possui um \underline{nome} que o identifica, bem como uma breve \underline{descrição} do que se trata, o \underline{local} em que vai ocorrer e a \underline{data} da sua realização.
